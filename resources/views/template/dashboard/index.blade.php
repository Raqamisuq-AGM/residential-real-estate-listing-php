                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-6">
                                            ...
                                            <div class="small-box bg-warning">
                                                ...
                                                <a href="{{ route('dashboard.properties.pending') }}"
                                                    class="small-box-footer">@lang('more info') <i
                                        ...
                                        <div class="col-lg-6 col-6">
                                            ...
                                            <div class="small-box bg-success">
                                                ...
                                                <a href="{{ route('dashboard.properties.approved') }}"
                                                    class="small-box-footer">@lang('more info') <i
                                                        class="fas fa-arrow-circle-right"></i></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-6">
                                            ...
                                            <div class="small-box bg-danger">
                                                ...
                                                <a href="{{ route('dashboard.properties.declined') }}"
                                                    class="small-box-footer">@lang('more info')
